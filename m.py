...
bot = telebot.TeleBot('7581195918:AAFxxQdt1F29NfV0ZFpe70UGry9FL2GQDGg')
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @NR_ADARSH_YTs 🙇."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @NR_ADARSH_YTs")
